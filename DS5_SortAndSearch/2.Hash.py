'''
    ...
    一、什么是散列
        ...
        散列函数可以将人一个数据项存储到集合中并返回一个介于槽命名区间（0 - m-1）的整数
        假设有11个空槽的一个散列-------------------------------------------------
